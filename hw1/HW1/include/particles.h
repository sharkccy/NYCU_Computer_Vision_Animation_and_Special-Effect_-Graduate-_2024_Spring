...
class Particles {
 public:
  ...
  //std::vector<float>& constrains() { return _constraints; }
  ...
  //float constraints(int i) const { return _constraints[i]; }
  ...
  //const float* getConstraintsData() const { return _constraints.data(); }
